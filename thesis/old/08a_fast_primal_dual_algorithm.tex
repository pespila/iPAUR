\chapter{A fast primal-dual algorithm} % (fold)
\label{cha:a_fast_primal_dual_algorithm}

% chapter a_fast_primal_dual_algorithm (end)
    ...
    % section minimizing_the_mumford_shah_functional (end)
        ...
        \subsection{Projection onto the convex sets and Dykstra's projection algorithm}
            ...
            \subsubsection{Dykstra's projection algorithm} % (fold)
...
% where C,D are convex sets. This problem is equivalent to finding the projection of r onto the set C\cap D, which we denote by \mathcal{P}_{C \cap D}.
                ...
                \begin{proof}
                    ...
                    \qed
                \end{proof}
            % subsection dykstra_s_projection_algorithm (end)
