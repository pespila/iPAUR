...
# ./ImageProcessing "../img/apple.png" "../img/apple_new.png"
./ImageProcessing "../img/lena_color_noisy.png" "../img/lena_color_noisy_new.png"
# ./ImageProcessing "../img/lena_color.png" "../img/lena_color_new.png"
