...
Mat write_image_data(color_img* image) {
...
void primal_dual_algorithm_video(color_img* src, void (*prox_f)(struct dual_vector_2d, struct dual_vector_2d, struct parameter*, int, int), void (*prox_g)(double**, double**, color_img*, struct parameter*), struct parameter* input_parameter, int spacing, int update, int steps) {
	...
	// VideoWriter output_cap("/Users/michael/Documents/Programming/ImageManipulation/ImageManipulation/img/edges.mp4");
	VideoWriter output_cap("/Users/michael/Documents/Programming/image-processing/img/lena.mp4",
                                  CV_FOURCC('m', 'p', '4', 'v'),
                                  20,
