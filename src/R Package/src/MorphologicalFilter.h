...
// 	void WhiteTopHat(Image<aType>&, Image<aType>&, int);
// 	void BlackTopHat(Image<aType>&, Image<aType>&, int);
// };
...
// template<typename aType>
// void MorphologicalFilter<aType>::WhiteTopHat(Image<aType>& src, Image<aType>& dst, int radius) {
//     Open(src, dst, radius);
//     int value;
...
// template<typename aType>
// void MorphologicalFilter<aType>::BlackTopHat(Image<aType>& src, Image<aType>& dst, int radius) {
