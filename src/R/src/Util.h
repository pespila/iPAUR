...
//     dst.Reset(src1.nrow(), src1.ncol(), src1.Type());
//     if (src1.nrow() != src2.nrow() || src1.ncol() != src2.ncol() || src1.Channels() != src2.Channels()) {
//         printf("Height, width and number of channels do not match!\n");
//     } else {
//         int value;
//         for (int k = 0; k < src1.Channels(); k++) {
...
//     dst.Reset(src.nrow(), src.ncol(), src.Type());
//     for (int k = 0; k < src.Channels(); k++)
//         for (int i = 0; i < src.nrow(); i++)
//             for (int j = 0; j < src.ncol(); j++)
