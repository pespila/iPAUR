...
template<typename aType>
void RGBAImage<aType>::Read(const string filename) {
...
template<typename aType>
void RGBAImage<aType>::Write(const string filename) {
...
template<typename aType>
void RGBAImage<aType>::Reset(int height, int width, char type) {
    free(image);
    image = NULL;
    this->channels = 4;
    this->height = height;
